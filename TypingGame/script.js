//Variebales
const levels_element = document.getElementById('levels');
const option_form = document.getElementById('options-form');
...
localStorage.getItem(levels): 'intermediate';
...
function RandomWord(){
    var random_index = Math.round(Math.random() * (words.length - 1));
...
options_form.addEventListener('change', e => {
